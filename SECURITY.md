...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/ddraig-ssg/security/advisories/new)
...
| **PGP Key** | [Download Public Key](https://hyperpolymath.org/gpg/security.asc) |
...
- This repository (`hyperpolymath/ddraig-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/ddraig-ssg/security/advisories)
...
When using ddraig-ssg, we recommend:
...
- [Our PGP Public Key](https://hyperpolymath.org/gpg/security.asc)
- [Security Advisories](https://github.com/hyperpolymath/ddraig-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/ddraig-ssg/security/advisories/new) or security@hyperpolymath.org |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/ddraig-ssg/discussions) |
...
*Thank you for helping keep ddraig-ssg and its users safe.* 🛡️
